...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BuyBuddyKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11BuyBuddyKit12TaskDelegate")
...
SWIFT_CLASS("_TtC11BuyBuddyKit16DataTaskDelegate")
...
SWIFT_CLASS("_TtC11BuyBuddyKit20DownloadTaskDelegate")
...
SWIFT_CLASS("_TtC11BuyBuddyKit15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(BuyBuddyKit)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BuyBuddyKit)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BuyBuddyKit)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BuyBuddyKit)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(BuyBuddyKit)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC11BuyBuddyKit18UploadTaskDelegate")
